import { LibertyDataModel } from '../../models/data_otchet/data.mjs'
import OtchetController from './otchet.mjs'
import { createUniversalData } from '../components/data.mjs'

const createData = async (req, res) => {
    try {
        await createUniversalData(req, res, LibertyDataModel, OtchetController, "Liberty");
    } catch (error) {
...
const getData = async (req, res) => {
    try {
        ...
        const data = await LibertyDataModel.find();
